    ...
    <template v-slot:content>
      <div v-show="!showPrintPreview" id="invoice" class="invoice">
        ...
        <div class="invoice__products">
          <m-table ref="tbProducts" :data="invoice.RefDetail" size="small" empty-text="Không có sản phẩm/ dịch vụ"
            width="100%" height="100%">
            <m-column type="index" label="#" width="40px" />
            <m-column prop="InventoryItemName" label="SP/dịch vụ" width="130px">
      ...
      <div v-if="showPrintPreview" id="print-element">
        ...
        <div class="p-products">
          <div class="p-product" v-for="(p, index) in invoice.RefDetail" :key="index">
