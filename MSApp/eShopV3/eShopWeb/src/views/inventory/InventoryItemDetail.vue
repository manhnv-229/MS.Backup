      ...
      <div class="inventory-form">
        ...
        <div class="inventory__info">
          ...
          <div class="m-row">
            <div class="m-col">
              <m-input
                label="Đơn giá mua (hỗ trợ nhập kho)"
                ref="txtInventoryCode"
...
export default {
  ...
  computed: {
    ...
    imgFullPath: function () {
      if (!this.id || this.imgChanged) {
        ...
        const serverFileUrl = process.env.VUE_APP_ServerFileUrl;
  ...
  created() {
    ...
    if (this.id && this.id !== "create") {
      ...
      this.maxios.get(`inventories/new-code`).then((res) => {
        this.inventory.InventoryItemCode = res;
      });
    }
    // this.$watch(
    //   () => this.$route.query,
