      ...
      <div class="org-container">
        ...
        <div class="m-tab">
          <div class="m-tab__list">
            <button class="m-tab__button" :class="{ 'm-tab__button--active': tabActive === 'info' }"
              @click="onChangeTab('info')">
              Thông tin cửa hàng
            </button>
            <button class="m-tab__button" :class="{ 'm-tab__button--active': tabActive === 'setting' }"
          ...
          <div class="m-tab__content">
            ...
            <div v-if="tabActive === 'info'" class="org--info">
              ...
              <div class="m-row">
                <div class="m-col">
                  <m-input label="Slogan (khẩu hiệu):" ref="txtorganizationCode" v-model="organization.Slogan"
                    :isDisabled="false">
                  </m-input>
                </div>
              </div>
              <div class="m-row">
                <div class="m-col">
                  <m-input label="Chủ doanh nghiệp/ đại lý" v-model="organization.OwnerName" :isDisabled="false"
                    :onlyNumberChar="true">
                  </m-input>
                </div>
                <div class="m-col"></div>
              ...
              <div class="m-row">
                <div class="m-col">
                  <m-input label="Số điện thoại" v-model="organization.PhoneNumber" :isDisabled="false" :required="true"
                    :onlyNumberChar="true">
                  </m-input>
                </div>
                <div class="m-col">
                  <m-input label="Email" v-model="organization.Email" :isDisabled="false" :required="true"
                    :onlyNumberChar="true">
                  </m-input>
                </div>
              </div>
            ...
            <div v-else-if="tabActive === 'setting'" class="org--setting">
              ...
              <div class="m-row" v-for="setting in organization.Setting" :key="setting">
                <div class="m-col">
                  <m-checkbox v-if="setting.SettingValueType == Enum.SettingValueType.BOOLEAN"
                    label="Gửi Email thông báo khi lập hoặc sửa hóa đơn. (Việc này có thể ảnh hưởng đến hiệu năng của chương trình.)"
                    v-model="setting.SettingValue" @onChange="onChangeSetting(setting)"></m-checkbox>
                  <m-input cls="setting-input" :label="setting.SettingName"
                    v-else-if="setting.SettingValueType == Enum.SettingValueType.INTEGER" v-model="setting.SettingValue"
                    :required="true" :disabled="false" :isFocus="false" :onlyNumberChar="true"
                    @onBlur="onChangeSetting(setting)" align="right">
                  </m-input>
                  <m-input :label="setting.SettingName"
                    v-else-if="setting.SettingValueType == Enum.SettingValueType.STRING" v-model="setting.SettingValue"
                    @onBlur="onChangeSetting(setting)" :required="true" :disabled="false" :isFocus="false">
                  </m-input>
                </div>
                <div class="m-col"></div>
              </div>
