<template>
  <div
    ...
    :class="{ cls: cls, 'm-combobox--custom': mode === 'custom' }"
  >
    ...
    >
      <span
        ...
        :class="{ right72: showAddButton == true && mode != 'custom' }"
  ...
  methods: {
    ...
    async loadData() {
      ...
      if (this.dataInput && Array.isArray(this.dataInput)) {
        ...
        headers.append("clientHost", clientHost);
...
/* CUSTOM */
.m-combobox--custom .combobox-wrapper label + .combobox{
  margin: unset;
}
.m-combobox--custom .combobox,
.m-combobox--custom .combobox--error {
  border: unset;
}

.m-combobox--custom .btnComboboxExt {
...
.m-combobox--custom .combobox__input {
  order: 2;
  border-radius: unset;
  border-bottom: 1px solid #dedede;
}

.m-combobox--custom .combobox__input:focus {
  border-bottom: 1px solid #00a43a ;
}

.m-combobox--custom .combobox__button {
  order: 3;
  border-top: unset;
  border-left: unset;
  border-right: unset;
...
.m-combobox--custom:has(.combobox__input:focus) .combobox__button{
  border-color: #00a43a;
}

.m-combobox--custom .combobox--error .combobox__input,
.m-combobox--custom .combobox--error .combobox__button {
  border-bottom: 1px solid #ff0000 !important;
}

.m-combobox--custom .combobox__button:hover {
