<template>
      ...
      <div class="order__left">
        <div class="order-info">
          ...
          <m-combobox
            ...
            label="Kho mặc định"
            ref="cbxStock"
            v-model="invoice.StockId"
            :firstSelected="true"
            :dataInput="stocks"
            @onSelected="onSelectStock"
            propText="StockName"
            propValue="StockId"
            :showAddButton="true"
            ...
            <m-table-layout>
              ...
              <template v-slot:container>
                ...
                >
                  ...
                  <m-column prop="InventoryItemCode" label="Mã SP" width="150">
                    <template #default="scope">
                      <div
                        class="flex"
                        :class="{
                  ...
                  <!-- <m-column prop="StockId" label="Kho">
                    <template #default="scope">
                      <m-combobox
                  ...
                  >
                    <template #default="scope">
                      <el-date-picker
                        ...
                        type="date"
                        format="DD-MM-YYYY"
                        @change="onChangeDateItem(scope.row)"
                      />
                    </template>
                  </m-column>
                  <m-column
                  ...
                  <m-column label="Đơn giá nhập" align="right" width="100px">
                    <template #default="scope">
                      <div class="unit-price">
                        <m-input
                          ...
                          :disabled="false"
                          :onlyNumberChar="true"
                          @onChange="onCostPriceChanged"
                          @onFocusIn="onFocusInCostPrice(scope.row)"
                          align="right"
                        ></m-input>
                        <!-- <el-tag>
      ...
      <div class="order__right">
          ...
          <div class="m-row">
            <div class="m-col">
              <m-combobox
                label="Nhà phân phối"
                mode="custom"
                v-model="invoice.AccountObjectId"
                url="/distributors"
                propValue="DistributorId"
                propText="DistributorName"
                @onChangeText="onInputDistributorName"
                @onSelected="onSelectDistributor"
                :showAddButton="true"
                @onClickExtButton="onDistributorAdd"
                ref="cbxDistributor"
              ></m-combobox>
            </div>
            <div class="m-col">
              <m-input
                label="SĐT"
                cls="minput--custom"
                v-model="invoice.AccountObjectPhoneNumber"
                :required="false"
                :isDisabled="false"
                :onlyNumberChar="true"
                type="tel"
          ...
          <div class="m-row">
            ...
            <div class="m-col">
              <m-input
                ...
                v-model="invoice.ContactPhoneNumber"
                :required="false"
                :isDisabled="false"
                :onlyNumberChar="true"
                type="tel"
        ...
        <div class="amount-info">
          ...
          <div class="money-acrtual">
            <label for="">Tiền phải trả cho nhà cung cấp:</label>
          ...
          <div class="money__remain">
            <label for="money-remain">Các khoản trả:</label>
          ...
          <div class="change-amount">
            <label for="">Tiền NCC trả lại:</label>
  ...
  ></SelectInventoryItem>
  <DistributorForm
    v-if="showDistributorAddForm"
    @onClose="showDistributorAddForm = false"
    @onSaveSuccess="onAddNewDistributorSuccess"
  ></DistributorForm>
  <InventoryItemDetail
  ...
  ></InventoryItemDetail>
  <StockDetail
    v-if="showStockAddForm"
    @onClose="showStockAddForm = false"
    @onSaveSuccess="onAddNewStokcSuccess"
  ></StockDetail>
</template>
