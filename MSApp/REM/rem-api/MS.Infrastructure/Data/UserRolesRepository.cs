...
namespace MS.Infrastructure.Data
{
    ...
    {
        public UserRolesRepository(IMSDatabaseContext dbContext,AutoMapper.IMapper mapper) : base(dbContext,mapper)
        {
        }
        ...
        public async Task<Guid> GetUserRoleIdByRoleValue(int roleValue)
        {
            ...
            var userRoleId = await DbContext.AppConnection.QueryFirstOrDefaultAsync<Guid>(sql, param: parameters, transaction: DbContext.Transaction);
            return userRoleId;
        }
    }
}
