...
namespace MS.Infrastructure.Data
{
    ...
    {
        public RefRepository(IMSDatabaseContext dbContext,AutoMapper.IMapper mapper) : base(dbContext,mapper)
        {
        }
        ...
        public override Task<int> AddAsync(dynamic entity, bool addChild = true)
        {
            return base.AddAsync(entity as Ref, addChild);
        }
        public async override Task<IEnumerable<Ref>> GetAllAsync()
        {
            var sql = "SELECT * FROM Ref i ORDER BY i.CreatedDate DESC";
            var invoices = await DbContext.AppConnection.QueryAsync<Ref>(sql);
            return invoices;
        }
        ...
        public async override Task<int> UpdateAsync(Ref invoice, object pks)
        {
            ...
            else
            {
                ...
                await UpdateListByEntityState<ServiceInvoice>(invoice.ServiceInvoices);
                await UpdateListByEntityState<SlotInvoice>(invoice.SlotInvoices);
            }
            ...
            await DbContext.AppConnection.ExecuteAsync(sqlDeleteDebitAndPayments, new { RefId = invoice.RefId }, transaction: DbContext.Transaction, commandType: System.Data.CommandType.Text);
        ...
        public async Task<string> GetNewRefNoAsync(Ref entity)
        {
            ...
            var res = await DbContext.AppConnection.QueryFirstOrDefaultAsync<string>(storeName, parameters,transaction:DbContext.Transaction, commandType: System.Data.CommandType.StoredProcedure);
            return res ?? "";
        }
        ...
        public async Task<RefResponse?> GetRefById(Guid id)
        {
            ...
            var res = await DbContext.AppConnection.QueryFirstOrDefaultAsync<RefResponse>(storeName, parameters, transaction: DbContext.Transaction, commandType: System.Data.CommandType.StoredProcedure);
            if (res != null)
            {
                res.Organization = await DbContext.AppConnection.QueryFirstOrDefaultAsync<Organization>(sqlGetOrg, param: parameters, commandType: System.Data.CommandType.Text);
                res.RefDetail = await DbContext.AppConnection.QueryAsync<RefDetailResponse>("Proc_Ref_GetRefDetailByRefId", parameters, commandType: System.Data.CommandType.StoredProcedure);
                res.StockInventory = await DbContext.AppConnection.QueryAsync<StockInventoryResponse>("Proc_Ref_GetStockInventoryByRefId", parameters, commandType: System.Data.CommandType.StoredProcedure);
                res.DebitDetail = await DbContext.AppConnection.QueryAsync<object>("Proc_Ref_GetDebitDetailByRefId", parameters, commandType: System.Data.CommandType.StoredProcedure);
                res.InvoicePayment = await DbContext.AppConnection.QueryAsync<object>("Proc_Ref_GetInvoicePaymentByRefId", parameters, commandType: System.Data.CommandType.StoredProcedure);
                
                var sqlGetServiceInvoice = "SELECT * FROM View_ServiceInvoice WHERE RefId = @p_refId";
                res.ServiceInvoice = await DbContext.AppConnection.QueryAsync<ServiceInvoiceDto>(sqlGetServiceInvoice, parameters, commandType: System.Data.CommandType.Text);
            }
            return res;
        }
        ...
        public async Task<PagingData> GetRefsByRefTypePaging(RefType? type, int limit, int offset, string? key)
        {
            ...
            parameters.Add("@p_organizationId", CommonFunction.OrganizationId);
            parameters.Add("@p_totalRecords", direction: System.Data.ParameterDirection.Output);
            var res = await DbContext.AppConnection.QueryAsync<object>(storeName, param: parameters, transaction: DbContext.Transaction, commandType: System.Data.CommandType.StoredProcedure);
            totalRecords = parameters.Get<int>("@p_totalRecords");
            var pagingData = new PagingData()
            {
                TotalRecords = totalRecords,
