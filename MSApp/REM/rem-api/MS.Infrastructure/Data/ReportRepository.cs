...
namespace MS.Infrastructure.Data
{
    ...
    {
        public ReportRepository(IMSDatabaseContext dbContext,AutoMapper.IMapper mapper) : base(dbContext,mapper)
        {
        }
        ...
        public async Task<object> GetProfitAmountByItems(DateTime? startDate, DateTime? endDate, string categoryId)
        {
            ...
            var data = await DbContext.AppConnection.QueryAsync<object>(storeName, parameters, transaction:DbContext.Transaction);
            return data;
        }
