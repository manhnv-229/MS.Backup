...
namespace MS.Infrastructure.Data
{
    ...
    {
        public SlotRepository(IMSDatabaseContext dbContext,AutoMapper.IMapper mapper) : base(dbContext,mapper)
        {
        }
        ...
        public new async Task<IEnumerable<object>> GetAllAsync()
        {
            ...
            var data = await DbContext.AppConnection.QueryAsync<SlotDto>(storeName,parameters, commandType:System.Data.CommandType.StoredProcedure);
        ...
        public async Task<SlotDto?> GetSlotDtoAsync(Guid? slotId)
        {
            ...
            var slotDto = await DbContext.AppConnection.QueryFirstOrDefaultAsync<SlotDto>(sql,parameters,transaction:DbContext.Transaction);
            return slotDto;
        }
    }
}
