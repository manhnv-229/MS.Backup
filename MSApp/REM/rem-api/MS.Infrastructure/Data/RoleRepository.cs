...
namespace MS.Infrastructure.Data
{
    ...
    {
        public RoleRepository(IMSDatabaseContext dbContext,AutoMapper.IMapper mapper) : base(dbContext,mapper)
        {
        }
        ...
        public async Task DeleteAllRoleByUserId(object userId)
        {
            ...
            await DbContext.AppConnection.ExecuteAsync(sql, parameters, transaction: DbContext.Transaction);
        }
        ...
        public async Task<Role> GetRoleByUserId(object userId)
        {
            ...
            DynamicParameters parameters= new DynamicParameters();
            parameters.Add("@UserId", userId);
            var role = await DbContext.AppConnection.QueryFirstOrDefaultAsync<Role>(sql, parameters,transaction:DbContext.Transaction);
            return role;
        }
    }
}
