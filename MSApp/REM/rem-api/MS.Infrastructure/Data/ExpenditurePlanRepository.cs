...
namespace MS.Infrastructure.Data
{
    ...
    {
        public ExpenditurePlanRepository(IMSDatabaseContext dbContext,AutoMapper.IMapper mapper) : base(dbContext,mapper)
        {
        }
        ...
        public async Task<IEnumerable<ExpenditurePlanResponse>> GetExpenditurePlans(int? type=null)
        {
            ...
            var expenditurePlans = await DbContext.AppConnection.QueryAsync<ExpenditurePlanResponse>(sql,param: parameters, transaction: DbContext.Transaction,commandType:System.Data.CommandType.StoredProcedure);
        ...
        public async Task<ExpenditurePlan> GetIncrementExpenditurePlanByEventId(object eventId)
        {
            ...
            var expenditurePlan = await DbContext.AppConnection.QueryFirstOrDefaultAsync<ExpenditurePlan>(sql, parameters, transaction:DbContext.Transaction);
