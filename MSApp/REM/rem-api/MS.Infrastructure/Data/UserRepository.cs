...
namespace MS.Infrastructure.Data
{
    public class UserRepository : DapperRepository<User>, IUserRepository
    {
        ...
        public UserRepository(IMSDatabaseContext dbContext, IMapper mapper) : base(dbContext,mapper)
        {
            _mapper = mapper;
        }
        public async Task<UserInfo> GetUserAuthenticate(string userName, string password)
        {
            ...
            var user = await DbContext.AppConnection.QueryFirstOrDefaultAsync<UserInfo>(sql, param: parameters, transaction: DbContext.Transaction);
            ...
            user.Roles = await DbContext.AppConnection.QueryAsync<Role>(sqlRoles, param: parameters, transaction: DbContext.Transaction);
            user.Employee = await DbContext.AppConnection.QueryFirstOrDefaultAsync<Employee>(sqlEmployee, param: parameters, transaction: DbContext.Transaction);
            return user;
        }
        ...
        public async override Task<User> GetByIdAsync(object id)
        {
            ...
            var userResponse = await DbContext.AppConnection.QueryFirstOrDefaultAsync<UserInfo>(sqlCommand, param: parameters, transaction: DbContext.Transaction);
            if (userResponse != null)
            {
                userResponse.Roles = await DbContext.AppConnection.QueryAsync<Role>(sqlSelectRoles, param: parameters, transaction: DbContext.Transaction);
        ...
        public new UserInfo GetById(Guid id)
        {
            ...
            var parameters = new DynamicParameters();
            parameters.Add($"@UserID", id);
            var user = DbContext.AppConnection.QueryFirstOrDefault<UserInfo>(sqlCommand, param: parameters, transaction: DbContext.Transaction);
            if (user != null)
            {
                user.Roles = DbContext.AppConnection.Query<Role>(sqlSelectRoles, param: parameters, transaction: DbContext.Transaction);
        ...
        public async Task<bool> CheckEmailExist(string email)
        {
            ...
            var res = await DbContext.AppConnection.QueryFirstOrDefaultAsync<User>(sql, param: parameters, transaction: DbContext.Transaction);
            if (res == null)
                return false;
            return true;
        }
        ...
        public async Task<bool> CheckUserNameExist(string userName)
        {
            ...
            var parameters = new DynamicParameters();
            parameters.Add("@UserName", userName);
            var res = await DbContext.AppConnection.QueryFirstOrDefaultAsync<Role>(sql, param: parameters, transaction: DbContext.Transaction);
            if (res == null)
                return false;
            return true;
        }
        ...
        public async Task<IList<string>> GetRolesAsync(User user)
        {
            ...
            var data = await DbContext.AppConnection.QueryAsync<string>(sql, param: parameters, commandType: System.Data.CommandType.StoredProcedure);
            return data.ToList();
        }
        ...
        public async Task<User> FindByNameAsync(string userName)
        {
            ...
            var parameters = new DynamicParameters();
            parameters.Add("@UserName", userName);
            var data = await DbContext.AppConnection.QueryFirstOrDefaultAsync<User>(sql, param: parameters, transaction: DbContext.Transaction);
            return data;
        }
        ...
        public async Task<bool> ConfirmUserToken(UserTokenConfirm userTokenConfirm)
        {
            try
            {
                ...
                var useToken = await DbContext.AppConnection.QueryFirstOrDefaultAsync<UserTokenConfirm>(sql, param: parameters, transaction: DbContext.Transaction);
                if (useToken.TokenCode == userTokenConfirm.TokenCode)
                {
                    ...
                    var res = await DbContext.AppConnection.ExecuteAsync(sqlUpdateConfirm, param: parameters, transaction: DbContext.Transaction);
                    if (res > 0)
                    {
        ...
        public async Task<IEnumerable<Role>> GetRoles()
        {
            ...
            var data = await DbContext.AppConnection.QueryAsync<Role>(sql);
            return data;
        }
        ...
        public async Task<int> ConfirmMultiUser(IEnumerable<User> users)
        {
            ...
            if (users != null)
            {
                foreach (var user in users)
                {
                    ...
                    // Cập nhật tình trạng
                    res += await DbContext.AppConnection.ExecuteAsync(sqlUpdateConfirm, param: parameters, transaction: DbContext.Transaction);

                    // Xóa Token (nếu có):
                    await DbContext.AppConnection.ExecuteAsync(sqlDeleteConfirm, param: parameters, transaction: DbContext.Transaction);
                }
            }
            return res;
        }
        ...
        public async Task<UserRegisterResponse> GetByPhoneNumber(string phoneNumber)
        {
            ...
            var data = await DbContext.AppConnection.QueryFirstOrDefaultAsync<UserRegisterResponse>(sql, param: parameters, transaction: DbContext.Transaction);
            return data;
        }
        ...
        public async Task<UserInfo> GetUserInfoResponseById(string id)
        {
            ...
            var parameters = new DynamicParameters();
            parameters.Add($"@UserID", id);
            var user = await DbContext.AppConnection.QueryFirstOrDefaultAsync<UserInfo>(sqlCommand, param: parameters, transaction: DbContext.Transaction);
            if (user != null)
            {
                user.Roles = await DbContext.AppConnection.QueryAsync<Role>(sqlSelectRoles, param: parameters, transaction: DbContext.Transaction);
                user.Employee = await DbContext.AppConnection.QueryFirstOrDefaultAsync<Employee>(sqlSelectEmployeeInfo, param: parameters, transaction: DbContext.Transaction);
        ...
        public async Task<string> GetUserNameByContactId(Guid contactId)
        {
            ...
            var userName = await DbContext.AppConnection.QueryFirstOrDefaultAsync<string>(sql, param: parameters, transaction: DbContext.Transaction);
            return userName;
        }
        ...
        public async Task<OrganizationInfo> GetOrganizationInfoByUserID(string? id = null)
        {
            ...
            var result = await DbContext.AppConnection.QueryFirstOrDefaultAsync<OrganizationInfo>(sql, param: parameters, transaction: DbContext.Transaction, commandType: System.Data.CommandType.StoredProcedure);
            if (result != null)
            {
                var sqlNavbar = "SELECT * FROM NavbarItem n WHERE n.OrganizationId = @p_OrganizationId OR n.IsSystem = 1 ORDER BY n.Sort";
                var navs = await DbContext.AppConnection.QueryAsync<NavbarItem>(sqlNavbar, parameters, transaction: DbContext.Transaction);
        ...
        public async Task<bool> ChangePassword(object userId, string passwordHash)
        {
            ...
            var res = await DbContext.AppConnection.ExecuteAsync(sql, parameters);
            if (res > 0)
            {
                return true;
            }
        ...
        public async Task UpdateUserName(object userId, string newUserName)
        {
            ...
            await DbContext.AppConnection.ExecuteAsync(sql: sql, param: parameters, transaction: DbContext.Transaction);
        }
    }
}
