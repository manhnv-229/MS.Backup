...
namespace MS.Infrastructure.Data
{
    public class OrganizationRepostiory : DapperRepository<Organization>, IOrganizationRepository
    {
        ...
        public OrganizationRepostiory(IMSDatabaseContext dbContext, IConfiguration configuration, INavbarItemRepository navRepository,AutoMapper.IMapper mapper) : base(dbContext,mapper)
        {
        ...
        public async override Task<PagingData> GetFilterPaging(string[] columnsSort, string[] columlsFilter, string keyFilter, int limit, int offset)
        {
            ...
            using (var multi = await DbContext.AppConnection.QueryMultipleAsync(sql, parameters, transaction: DbContext.Transaction))
            {
        ...
        public async Task<Organization> GetOrganizationByUserName(string userName)
        {
            ...
            var org = await DbContext.AppConnection.QueryFirstOrDefaultAsync<Organization>(sql, parameters, transaction: DbContext.Transaction);
            return org;
        }
        ...
        public Task<IEnumerable<OrganizationStatisticDto>> GetOrgStatisticByDay(DateTime? date)
        {
            ...
            var data = DbContext.AppConnection.QueryAsync<OrganizationStatisticDto>(storeName, param: parameters, transaction: DbContext.Transaction, commandType: System.Data.CommandType.StoredProcedure);
            return data;
        }
        ...
        public async override Task<Organization> GetByIdAsync(object pksFields)
        {
            ...
            var setting = await DbContext.AppConnection.QueryAsync<Setting>(storeGetSetting, parameters, transaction: DbContext.Transaction);
