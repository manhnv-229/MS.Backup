...
namespace MS.Core.Exceptions
{
    public class MSException : Exception
    {
        ...
        public MSException(HttpStatusCode statusCode, string msg)
        {
            Msg = msg;
        ...
        public MSException(HttpStatusCode statusCode,Dictionary<string,List<string>> errors)
        {
            Errors = errors;
            StatusCode = statusCode;
        }

        public MSException(string msg, List<string>? errors = null)
        {
            Msg = msg;
            Errors = new Dictionary<string, List<string>>();
            if (errors == null)
