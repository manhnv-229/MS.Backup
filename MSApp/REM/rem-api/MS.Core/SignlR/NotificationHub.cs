...
namespace MS.Core.Core
{
    ...
    public class NotificationHub : Hub, INotificationHub
    {
        ...
        public override async Task OnConnectedAsync()
        {
            ...
            var orgId = Context.User?.Claims?.First(x => x.Type == "OrganizationId").Value;
            ...
            if (orgId != null)
            {
                _connections.AddToConnectionsByOrg(orgId, connectionId);
            }
        ...
        public override async Task OnDisconnectedAsync(Exception? exception)
        {
            ...
            // Xóa connection ID trong thùng chứa connectionId theo đơn vị:
            if (orgId != null)
            {
                _connections.RemoveConnectionByOrgId(orgId, connectionId);
            }
