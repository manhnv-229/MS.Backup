...
namespace MS.Core.Services
{
    public class BaseService<TEntity> : IBaseService<TEntity> where TEntity : BaseEntity
    {
        ...
        public virtual async Task<int> AddAsync(dynamic entity, IFormCollection? formData = null)
        {
        ...
        public virtual async Task<int> UpdateAsync(dynamic entity, object pks, IFormCollection? formData = null)
        {
            UnitOfWork.BeginTransaction();
        ...
        private async Task ProcessEntityBeforeSave(dynamic entity)
        {
        ...
        protected virtual async Task BeforeSave(dynamic entity)
        {
        }

        protected virtual async Task AfterSave(dynamic entity, bool saveSuccess = true)
        {
        }

        private async Task ValidateObject(dynamic entity)
        {
            var type = entity.GetType();
            var method = GetType()?.GetMethod("Validate")?.MakeGenericMethod(new Type[] { type });
            var task = (Task?)method?.Invoke(this, new object[] { entity });
        ...
        protected virtual async Task ValidateObjectCustom(dynamic entity)
        {
