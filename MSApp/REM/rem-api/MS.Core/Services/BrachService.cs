...
namespace MS.Core.Services
{
    public class BrachService : BaseService<Branch>, IBranchService
    {
        ...
        public async override Task<int> AddAsync(dynamic entity, IFormCollection? formData = null)
        {
            if (entity is Branch)
            {
            ...
            {
                throw new MSException(System.Net.HttpStatusCode.InternalServerError, "Có lỗi xảy ra vui lòng liên hệ Mạnh Software để được trợ giúp.");
            }
        }
    }
}
