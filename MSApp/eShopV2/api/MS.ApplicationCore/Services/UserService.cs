...
using static MS.ApplicationCore.Interfaces.IEmailService;
...
namespace MS.ApplicationCore.Services
{
    public class UserService : BaseService<User>, IUserService
    {
        ...
        public async Task<int> Register(RegisterModel registerModel)
        {
            ...
            {
                throw new MISAException(System.Net.HttpStatusCode.InternalServerError, "Có lỗi khi xử lý đăng ký tài khoản mới, vui lòng liên hệ Quản trị viên để được trợ giúp.");
            }
        ...
        public async Task<bool> ChangePassword(UserChangePassword userChangePassword)
        {
            ...
            else
            {
                ...
                {
                    throw new MISAException(System.Net.HttpStatusCode.BadRequest,"Thông tin tài khoản hoặc mật khẩu không chính xác.");
                }
            }
        }
    }
