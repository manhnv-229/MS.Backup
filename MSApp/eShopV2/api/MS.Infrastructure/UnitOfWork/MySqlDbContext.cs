...
namespace MS.Infrastructure.UnitOfWork
{
    public class MySqlDbContext : IDisposable
    {
        ...
        public MySqlDbContext(IConfiguration configuration, IWebHostEnvironment _env)
        {
            try
            {
        ...
        public async Task<string> GetNewCodeDynamic<T>()
        {
        ...
        public virtual async Task<int> DeleteAsync<T>(object id)
        {
