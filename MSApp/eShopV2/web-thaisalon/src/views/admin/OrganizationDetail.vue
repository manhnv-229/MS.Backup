          ...
          <div v-if="id" class="org-update">
            ...
            <div class="function-button">
              ...
              <button
                ...
                @click.prevent="onConfirmOrganization(false)"
              >
  ...
  methods: {
    ...
    onCancelVIP() {
      this.commonJs.showConfirm(
        ...
        () => {
          this.maxios.delete(`organizations/${this.organization.OrganizationId}/licenses`, this.license)
            .then(()=>{
                this.loadData();
            })
        }
