...
namespace MS.Core.Authorization
{
    ...
    public class JwtUtils : IJwtUtils
    {
        ...
        public string GenerateJwtToken(UserInfo user)
        {
            ...
            string employeeName = user.Employee?.FullName != null ? user.Employee?.FullName.ToString() : string.Empty;
        ...
        public JwtInfo ValidateJwtToken(string token)
        {
            ...
            jwInfo.EmployeeId = jwtToken.Claims.First(x => x.Type == "EmployeeId").Value.ToString();
            ...
            jwInfo.EmployeeName = jwtToken.Claims.First(x => x.Type == "EmployeeName").Value.ToString();
            var role = jwtToken.Claims.First(x => x.Type == ClaimTypes.Role)?.Value;
            CommonFunction.OrganizationId = jwInfo.OrganizationId;
            CommonFunction.UserId = jwInfo.UserId;
            CommonFunction.EmployeeId = jwInfo.EmployeeId;
            CommonFunction.EmployeeName = jwInfo.EmployeeName;
            if (role != null)
            {
