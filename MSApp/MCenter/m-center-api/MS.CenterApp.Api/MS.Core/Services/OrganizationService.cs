...
namespace MS.Core.Services
{
    public class OrganizationService : BaseService<Organization>, IOrganizationService
    {
        ...
        protected async override Task BeforeSave(Organization entity)
        {
            var navbarItems = entity.NavbarItem;
        ...
        protected async override Task AfterSave(Organization entity, bool saveSuccess = true)
        {
            // Cập nhật lại cache:
