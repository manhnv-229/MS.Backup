...
namespace MS.Infrastructure.Data
{
    ...
    {
        public CustomerRepository(IMSDatabaseContext dbContext) : base(dbContext)
        {
        }
        ...
        public async override Task<IEnumerable<Customer>> GetAllAsync()
        {
            ...
            customers = (await DbContext.Connection.QueryAsync<Customer>(sql, transaction: DbContext.Transaction))?.ToList();
            if (customers != null)
            {
