...
namespace MS.Infrastructure.Data
{
    public class RefRepository : DapperRepository<Ref>, IRefRepository
    {
        ...
        public async Task<string> GetNewRefNoAsync(Ref entity)
        {
            ...
            var res = await DbContext.Connection.QueryFirstOrDefaultAsync<string>(storeName, parameters,transaction:DbContext.Transaction, commandType: System.Data.CommandType.StoredProcedure);
            return res ?? "";
        }
        ...
        public async Task<RefResponse?> GetRefById(Guid id)
        {
            ...
            var res = await DbContext.Connection.QueryFirstOrDefaultAsync<RefResponse>(storeName, parameters, transaction: DbContext.Transaction, commandType: System.Data.CommandType.StoredProcedure);
            if (res != null)
            {
