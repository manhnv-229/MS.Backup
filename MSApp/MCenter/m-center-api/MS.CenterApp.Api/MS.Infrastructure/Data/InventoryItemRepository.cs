...
namespace MS.Infrastructure.Data
{
    ...
    {
        public InventoryItemRepository(IMSDatabaseContext dbContext) : base(dbContext)
        {
        }
        ...
        public async Task<IEnumerable<InventoryItemResponse>> GetInventoryItemAdminResponses()
        {
            ...
            var inventoryItems = await DbContext.Connection.QueryAsync<InventoryItemResponse>(storeName, parameters, transaction: DbContext.Transaction, commandType: System.Data.CommandType.StoredProcedure);
        ...
        public async Task<IEnumerable<InventoryItemSaleResponse>> GetInventoryItemSaleResponses()
        {
            ...
            DynamicParameters parameters = new DynamicParameters();
            parameters.Add("@p_Organization", CommonFunction.OrganizationId);
            var products = await DbContext.Connection.QueryAsync<InventoryItemSaleResponse>(storeName, parameters, transaction: DbContext.Transaction, commandType: System.Data.CommandType.StoredProcedure);
            return products;
        }
        ...
        public async Task<string> GetNewCodeAuto(string prefixCode)
        {
            ...
            var newCode = await DbContext.Connection.QueryFirstOrDefaultAsync<string>(storeName, parameters, transaction: DbContext.Transaction, commandType: System.Data.CommandType.StoredProcedure);
