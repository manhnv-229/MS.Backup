      ...
      <div class="org-container">
        ...
        <div class="m-tab">
          <div class="m-tab__list">
            ...
            <button
              class="m-tab__button"
              :class="{ 'm-tab__button--active': tabActive === 'other' }"
              @click="onChangeTab('other')"
            >
              Khác
            </button>
          </div>
          <div class="m-tab__content">
            ...
            <div v-else-if="tabActive === 'other'" class="org--setting">
...
export default {
  ...
  emits: ["onClose"],
  props: ["id"],
  components: { NavbarSetting, SystemConfig },
  inject: ["organization"],
  computed: {
    dragOptions() {
      return {
  ...
  methods: {
    ...
    onSave() {
      this.organization.EntityState = this.Enum.EntityState.UPDATE;
      this.maxios
        .put(
